...
class BasePage(ctk.CTkFrame):
    ...
    def __init__(self,master,controller,**kwargs):
        ...
        if self.subtitle:
            ctk.CTkLabel(header,text=self.subtitle,text_color=theme.TEXT_MUTED,font=(theme.FONT,11)).pack(anchor="w",pady=(3,0))
    ...
    def refresh_from_state(self, reason: str = ""): pass
    def clear_body(self):
